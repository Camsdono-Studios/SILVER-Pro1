...
void main() => runApp(const CosAdjacentWorkingScreen());


// Define a custom Form widget.
class CosAdjacentWorkingScreen extends StatefulWidget {
  const CosAdjacentWorkingScreen({Key? key}) : super(key: key);
...
class _MyCustomFormState extends State<CosAdjacentWorkingScreen> {
  ...
  void calculate() {
    ...
    angle = cos(double.parse(angleController.text) * pi / 180);
                    ...
                    builder: (context) {
                      ...
                      return AlertDialog(
                          ...
                          content: Text(
                              ...
                              "x = " + adjacentController.text + " * " + "cos" + angleController.text +
                                  "\n" +
                                  "x = " + adjacentController.text + " * " + cos(double.parse(angleController.text) * pi / 180).toStringAsFixed(3) +
                                  "\n" +
