...
void main() => runApp(const CosAngleWorkingScreen());


// Define a custom Form widget.
class CosAngleWorkingScreen extends StatefulWidget {
  const CosAngleWorkingScreen({Key? key}) : super(key: key);
...
class _MyCustomFormState extends State<CosAngleWorkingScreen> {
  ...
  void calculate() {
    ...
    answer1 = adjacent / opposite;
    answer1.toString();
    answer2 = Angle.acos(answer1);
    answer2.toString();
  }
                  ...
                  showDialog(
                    ...
                    builder: (context) {
                      ...
                      return AlertDialog(
                          ...
                          content: Text(
                              "Cos x° = " + adjacentController.text + " ÷ " + oppositeController.text +
                                  "\n" +
                                  "Cos x° = " + answer1.toStringAsFixed(3) +
                                  "\n" +
                                  "Cos(-1)" + answer1.toStringAsFixed(3) + " = x°"
                                  "\n" +
                                  "x° = " + answer2.toString(),
